jQuery(document).ready(function ($) {
    ...
    class SlideItem {
        ...
        onFoundVariation(event, variation) {
            ...
            if (this.elem.hasClass('addToCartSingle')) {
                this.elem.find('.price span').text(variation.display_price);
            }
            ;
            ...
            this.elem.find('#amount_phone').text(variation.display_price);
        }
    }
    ...
    function initCheckout() {
        ...
        $('#billingForm').on('submit', function (event) {
            ...
            $.post(wcAjaxUrl('checkout'), arr, (res) => {
                $('.billing-errors').html(res.messages || '');
