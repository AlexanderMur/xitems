            ...
            <div class="footer-right">
                <ul class="footer-socials">
                    ...
                    foreach ($socials as $social) {
                        ?>
                        <li>
                            <a href="<?php echo $social['social_link'] ?>"><?php echo wp_get_attachment_image($social['social_image'], 'post-thumbnail') ?></a>
                        </li>
                        <?php
                    }
                    ?>
...
<div class="checkout">
    ...
    <div class="checkout-item checkout-order" id=checkoutOrder>
        <form name="checkout" method="post" action="<?php echo esc_url(wc_get_checkout_url()); ?>" id="billingForm">
                ...
                <div class="box-field submit">
                    <div class="box-field__input">
                        <button name="woocommerce_checkout_place_order"
                                id="place_order"
                                type="submit"
                                class="main-button submit-control"
                        >Оформить заказ
                        </button>
                    </div>
                </div>
